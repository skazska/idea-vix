...
This document captures the implemented CRUD contract for boards and packages. Status tags at the end of each bullet follow the conventions used in `non-functional.md`:
...
- Packages and Boards allow their workshop composition [] 
...
- Boards import package content by slug; the slug mapping is consumed during drawing workflows per `../stories/diagrams.md#drawing`. [v]